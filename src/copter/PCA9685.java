...
public class PCA9685 {
    ...
    private PCA9685() {
        try {
            ...
            final PCA9685GpioProvider gpioProvider = new PCA9685GpioProvider(this.bus, 0x40, frequency, frequencyCorrectionFactor);
            myOutputs = provisionPwmOutputs(gpioProvider);
            // Reset outputs
            gpioProvider.reset();
        } catch (IOException ex) {
            Logger.getLogger(PCA9685.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public static PCA9685 getInstance() {
        if (instance == null) {
            instance = new PCA9685();
        }
        return instance;
    }
